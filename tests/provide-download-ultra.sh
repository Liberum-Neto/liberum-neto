...
N2="test_n2"
N2_SEED=2
N2_ADDR="/ip6/::1/udp/53138/quic-v1"
...
N3="test_n3"
N3_SEED=3
N3_ADDR="/ip6/::1/udp/53139/quic-v1"
...
N4="test_n4"
N4_SEED=4
N4_ADDR="/ip6/::1/udp/53140/quic-v1"
...
# publish files
cargo run -p liberum_cli -- -d provide-file $N1 "$FILE1_NAME" 2> /dev/null
cargo run -p liberum_cli -- -d provide-file $N2 "$FILE2_NAME" 2> /dev/null
cargo run -p liberum_cli -- -d provide-file $N3 "$FILE3_NAME" 2> /dev/null
cargo run -p liberum_cli -- -d provide-file $N4 "$FILE4_NAME" 2> /dev/null

# dial
cargo run -p liberum_cli -- -d dial $N4 $N3_ID $N3_ADDR 2> /dev/null

# download files
#RESULT11=$(cargo run -p liberum_cli download-file-rr $N1 "${FILE1_HASH}" 2> /dev/null)
RESULT12=$(cargo run -p liberum_cli download-file-rr $N1 "${FILE2_HASH}" 2> /dev/null)
RESULT13=$(cargo run -p liberum_cli download-file-rr $N1 "${FILE3_HASH}" 2> /dev/null)
RESULT14=$(cargo run -p liberum_cli download-file-rr $N1 "${FILE4_HASH}" 2> /dev/null)

RESULT21=$(cargo run -p liberum_cli download-file-rr $N2 "${FILE1_HASH}" 2> /dev/null)
#RESULT22=$(cargo run -p liberum_cli download-file-rr $N2 "${FILE2_HASH}" 2> /dev/null)
RESULT23=$(cargo run -p liberum_cli download-file-rr $N2 "${FILE3_HASH}" 2> /dev/null)
RESULT24=$(cargo run -p liberum_cli download-file-rr $N2 "${FILE4_HASH}" 2> /dev/null)

RESULT31=$(cargo run -p liberum_cli download-file-rr $N3 "${FILE1_HASH}" 2> /dev/null)
RESULT32=$(cargo run -p liberum_cli download-file-rr $N3 "${FILE2_HASH}" 2> /dev/null)
#RESULT33=$(cargo run -p liberum_cli download-file-rr $N3 "${FILE3_HASH}" 2> /dev/null)
RESULT34=$(cargo run -p liberum_cli download-file-rr $N3 "${FILE4_HASH}" 2> /dev/null)

RESULT41=$(cargo run -p liberum_cli download-file-rr $N4 "${FILE1_HASH}" 2> /dev/null)
RESULT42=$(cargo run -p liberum_cli download-file-rr $N4 "${FILE2_HASH}" 2> /dev/null)
RESULT43=$(cargo run -p liberum_cli download-file-rr $N4 "${FILE3_HASH}" 2> /dev/null)
#RESULT44=$(cargo run -p liberum_cli download-file-rr $N4 "${FILE4_HASH}" 2> /dev/null)
